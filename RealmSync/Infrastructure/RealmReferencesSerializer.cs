    ...
    public class RealmReferencesSerializer : JsonConverter
    {
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            if (list != null)
            {
                ...
                foreach (var obj in list.OfType<IRealmSyncObjectClient>())
                {
            ...
            var realmObject = value as IRealmSyncObjectClient;
            if (realmObject == null)
            {
                throw new SerializationException($"{nameof(RealmReferencesSerializer)} can only be applied to properties implementing {nameof(IRealmSyncObjectClient)}");
            }
