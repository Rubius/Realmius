...
namespace Realmius.Server.Models
{
    public class ChangeTrackingDbContext : DbContext
    {
        ...
        private void ProcessAndAddChanges(SyncStatusServerObject syncStatusObject, IRealmSyncObjectServer obj, UpdatedDataBatch updatedResult, string changes)
        {
        ...
        protected virtual void Process(SyncStatusServerObject syncStatusObject, IRealmSyncObjectServer obj)
        {
        ...
        public void AttachObjects(IEnumerable<IRealmSyncObjectServer> objects)
        {
            var syncStatusContext = CreateSyncStatusContext();
        ...
        {
            var obj = (IRealmSyncObjectServer)GetObjectByKey(type, id);
            AttachObject(obj);
        }

        public void AttachObject(IRealmSyncObjectServer obj)
        {
            AttachObjects(new[] { obj });
        }

        private void AttachObject(IRealmSyncObjectServer obj, SyncStatusDbContext syncStatusContext, UpdatedDataBatch updatedResult)
        {
            var typeName = GetEfTypeName(obj);
        ...
        public T CloneWithOriginalValues<T>(T dbEntity)
            where T : class, IRealmSyncObjectServer
        {
