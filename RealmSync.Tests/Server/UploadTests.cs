...
namespace RealmSync.Tests.Server
{
    ...
    public class UploadTests : TestBase
    {
        ...
        public UploadTests()
        {
            _config = new ShareEverythingRealmSyncServerConfiguration(typeof(DbSyncObject), typeof(DbSyncObjectWithIgnoredFields), typeof(IdIntAutogeneratedObject), typeof(RefSyncObject));
        ...
        public class IntFieldSentAsStringObject : IRealmSyncObjectServer
        {
        ...
        {
            var controller = new RealmSyncServerProcessor(_contextFunc, new ShareEverythingRealmSyncServerConfiguration(typeof(IntFieldSentAsStringObject)));
            var result = controller.Upload(new UploadDataRequest()
            {
                ChangeNotifications =
                {
        ...
        public void ManyToManyRef()
        {
            ...
            var controller = new RealmSyncServerProcessor(_contextFunc, typeof(RefSyncObject));
            var result = controller.Upload(new UploadDataRequest()
            {
                ChangeNotifications =
                {
        ...
        public class SyncConfigForCustomId : ShareEverythingRealmSyncServerConfiguration
        {
        ...
        public void IdInteger()
        {
            ...
            var controller = new RealmSyncServerProcessor(_contextFunc, new SyncConfigForCustomId(typeof(IdIntObject)));
        ...
        public void IdAutoIncrementInteger()
        {
            ...
            var controller = new RealmSyncServerProcessor(_contextFunc, new SyncConfigForCustomId(typeof(IdIntAutogeneratedObject)));
        ...
        public void IdGuid()
        {
            ...
            var controller = new RealmSyncServerProcessor(_contextFunc, new SyncConfigForCustomId(typeof(IdGuidObject)));
        ...
        public void DoNotUpdateIgnoredFields()
        {
            ...
            var controller = new RealmSyncServerProcessor(_contextFunc, typeof(DbSyncObjectWithIgnoredFields));
        ...
        public void UploadData_CheckAndProcessCanRetrieveUnmodifiedEntityFromDatabase()
        {
            ...
            var config = new Mock<ShareEverythingRealmSyncServerConfiguration>(typeof(DbSyncObjectWithIgnoredFields))
            {
                CallBase = true
            };

            var controller = new RealmSyncServerProcessor(_contextFunc, config.Object);
