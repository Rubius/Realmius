...
namespace RealmSync.Tests.Client
{
    ...
    public class RealmSyncServiceTests : TestBase
    {
        ...
        public void Setup()
        {
            ...
            _uploadTask = null;
            RealmSyncService.DelayWhenUploadRequestFailed = 10;
        }
        ...
        private Mock<RealmSyncService> CreateSyncService()
        {
            ...
            var mock = new Mock<RealmSyncService>(func, _apiClientMock.Object, false, new[] { typeof(DbSyncClientObject), typeof(DbSyncClientObject2), typeof(DbSyncWithDoNotUpload) })
            {
                CallBase = true,
            };
        ...
        public void PartialUpdate_NoObjectOnClient()
        {
            ...
            _syncService.RealmSync.Refresh();
            ...
            _syncService.RealmSync.All<UploadRequestItemRealm>().Count().Should().Be(0);
        }
        ...
        public void Reconnect_LastChangeIsPreserved_IfFlagIsNotSpecified()
        {
            ...
            var syncService = new RealmSyncService(GetRealm, _apiClientMock.Object, false, new[] { typeof(DbSyncClientObject) });
        ...
        public void Reconnect_LastChangeIsPreserved_FlagIsSpecified()
        {
            ...
            var syncService2 = new RealmSyncService(GetRealm, _apiClientMock.Object, false, new[] { typeof(DbSyncClientObject) });
        ...
        private class Serializer1 : RealmObject, IRealmSyncObjectClient
        {
        ...
        private class Serializer_Link : RealmObject, IRealmSyncObjectClient
        {
            public string Id { get; set; }
            public DbSyncClientObject DbSyncClientObject { get; set; }
            public string MobilePrimaryKey => Id;
        }
        private class Serializer_Collection : RealmObject, IRealmSyncObjectClient
        {
            public string Id { get; set; }
