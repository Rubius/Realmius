...
namespace Realmius.Tests.Server
{
    ...
    public class UploadTests : TestBase
    {
        ...
        public UploadTests()
        {
            _config = new ShareEverythingRealmiusServerConfiguration(typeof(DbSyncObject), typeof(DbSyncObjectWithIgnoredFields), typeof(IdIntAutogeneratedObject), typeof(RefSyncObject));
        ...
        {
            var controller = new RealmiusServerProcessor(_contextFunc, new ShareEverythingRealmiusServerConfiguration(typeof(UnknownSyncObject)));
        ...
        {
            var controller = new RealmiusServerProcessor(_contextFunc, new ShareEverythingRealmiusServerConfiguration(typeof(IntFieldSentAsStringObject)));
            var result = controller.Upload(new UploadDataRequest()
            {
                ChangeNotifications =
                {
        ...
        {
            var controller = new RealmiusServerProcessor(_contextFunc, typeof(DbSyncObject));
            var result = controller.Upload(new UploadDataRequest()
            {
                ChangeNotifications =
                {
        ...
        public void ManyToManyRef()
        {
            ...
            var controller = new RealmiusServerProcessor(_contextFunc, typeof(RefSyncObject));
            var result = controller.Upload(new UploadDataRequest()
            {
                ChangeNotifications =
                {
        ...
        public class SyncConfigForCustomId : ShareEverythingRealmiusServerConfiguration
        {
            public SyncConfigForCustomId(Type typeToSync, params Type[] typesToSync) : base(typeToSync, typesToSync)
            {
            }
        ...
        public void IdInteger()
        {
            ...
            var controller = new RealmiusServerProcessor(_contextFunc, new SyncConfigForCustomId(typeof(IdIntObject)));
        ...
        public void IdAutoIncrementInteger()
        {
            ...
            var controller = new RealmiusServerProcessor(_contextFunc, new SyncConfigForCustomId(typeof(IdIntAutogeneratedObject)));
        ...
        public void IdGuid()
        {
            ...
            var controller = new RealmiusServerProcessor(_contextFunc, new SyncConfigForCustomId(typeof(IdGuidObject)));
        ...
        public void DoNotUpdateIgnoredFields()
        {
            ...
            var controller = new RealmiusServerProcessor(_contextFunc, typeof(DbSyncObjectWithIgnoredFields));
        ...
        public void UploadData_CheckAndProcessCanRetrieveUnmodifiedEntityFromDatabase()
        {
            ...
            var config = new Mock<ShareEverythingRealmiusServerConfiguration>(typeof(DbSyncObjectWithIgnoredFields))
            {
                CallBase = true
            };

            var controller = new RealmiusServerProcessor(_contextFunc, config.Object);
            ...
            config.Setup(
                    x =>
                        x.CheckAndProcess(It.IsAny<CheckAndProcessArgs<ISyncUser>>()))
                .Returns((CheckAndProcessArgs<ISyncUser> args) =>
                {
