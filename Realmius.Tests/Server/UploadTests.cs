...
namespace Realmius.Tests.Server
{
    ...
    public class UploadTests : TestBase
    {
        ...
        public UploadTests()
        {
            _config = new ShareEverythingConfiguration(typeof(DbSyncObject), typeof(DbSyncObjectWithIgnoredFields), typeof(IdIntAutogeneratedObject), typeof(RefSyncObject));
        ...
        {
            var controller = new RealmiusServerProcessor(_contextFunc, new ShareEverythingConfiguration(typeof(UnknownSyncObject)));
        ...
        {
            var controller = new RealmiusServerProcessor(_contextFunc, new ShareEverythingConfiguration(typeof(IntFieldSentAsStringObject)));
            var result = controller.Upload(new UploadDataRequest()
            {
                ChangeNotifications =
                {
        ...
        public void UploadData_CheckAndProcessCanRetrieveUnmodifiedEntityFromDatabase()
        {
            ...
            var config = new Mock<ShareEverythingConfiguration>(typeof(DbSyncObjectWithIgnoredFields))
            {
                CallBase = true
            };
            ...
            config.Setup(
                    x =>
                        x.CheckAndProcess(It.IsAny<CheckAndProcessArgs<IRealmiusUser>>()))
                .Returns((CheckAndProcessArgs<IRealmiusUser> args) =>
                {
