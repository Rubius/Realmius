...
namespace Realmius.Tests.Server
{
    public class UploadTests : TestBase
    {
        ...
        {
            public SyncConfigForCustomId(Func<ChangeTrackingDbContext> contextFactoryFunc, Type typeToSync, Type[] typesToSync) : base(contextFactoryFunc, typeToSync, typesToSync)
            {
            }
        ...
        public void IdInteger()
        {
            ...
            var controller = new RealmiusServerProcessor(new SyncConfigForCustomId(_contextFunc, typeof(IdIntObject), new Type[]{}));
        ...
        public void IdAutoIncrementInteger()
        {
            ...
            var controller = new RealmiusServerProcessor(new SyncConfigForCustomId(_contextFunc, typeof(IdIntAutogeneratedObject), new Type[] { }));
        ...
        public void IdGuid()
        {
            ...
            var controller = new RealmiusServerProcessor(new SyncConfigForCustomId(_contextFunc, typeof(IdGuidObject), new Type[] { }));
